<template>
  ...
  >
    <template #media>
      ...
      />
      <div class="svg-container" v-if="notification.data.type.toLowerCase()=='like_interaction'" style="width: 80px; height: 80px; background-color: rgba(1,255,160,0.05); border-radius: 8px">
  ...
  <div class="svg-container" v-if="notification.data.type=='follow'" style="width: 80px; height: 80px; background-color: rgba(1,255,160,0.05); border-radius: 8px">
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#01ffa0" class="bi bi-person-vcard" viewBox="0 0 16 16">
