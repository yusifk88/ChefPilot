...
<span v-if="loading">
  ...
  >
    <div style="padding: 10px; background-color: #00ff9f; border-radius: 15px!important; color: #000000!important;">
      The discover feature helps you discover recipes from the ChefPilot community and their thoughts and experiences on some recipes. It is work in progress so we will be improving it as time goes on.
