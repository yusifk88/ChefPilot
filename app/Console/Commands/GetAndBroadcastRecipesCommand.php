...
class GetAndBroadcastRecipesCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'app:get-and-broadcast-recipes';
     ...
     * @var string
     */
    protected $description = 'Determine the correct time to get recipes in all timezones and get recipes for users at 7Am in the user timezone';
